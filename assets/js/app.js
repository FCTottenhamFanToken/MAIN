...
let addr;
const sttaddr = "0x33eb264ee0cfd1158ac3bc059caddc78205217ff";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x33eb264ee0cfd1158ac3bc059caddc78205217ff";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://tottenhamfantoken.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x33eb264ee0cfd1158ac3bc059caddc78205217ff',
                    'symbol': 'JTOTTENHAM HOTSPUR',
                    'decimals': '18',
                    'image': 'https://tottenhamfantoken.com/images/logo.png',
                },
            },
